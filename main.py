...
async def main_async():
    ...
    try:
        ...
        try:
            current_session = session_service.create_session(app_name=APP_NAME, user_id=USER_ID, session_id=SESSION_ID, state=user_initial_state)
    ...
    while True:
        ...
        try:
            current_session = session_service.get_session(app_name=APP_NAME, user_id=USER_ID, session_id=active_session_id)
        except Exception as e:
